...
/**
 * Represents the web shop's inventory management system. It stores lists of
 * available computers, smartphones, and other electronics. The `Warehouse`
 * is responsible for generating an initial stock of these products.
 *
 * @author Marcin
 * @version 1.0
 */
